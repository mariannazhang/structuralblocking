...
aov(essentialism ~ 1 + context * explanation, data = (df.subj.adults %>% filter(data_group == "adult original"))) %>% 
  summary()

aov(essentialism ~ 1 + context * explanation, data = (df.subj.adults %>% filter(data_group == "adult replication"))) %>% 
  summary()
